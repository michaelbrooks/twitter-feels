...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TweetChunk.twitter_id'
        db.add_column(u'map_tweetchunk', 'twitter_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TweetChunk.tweet_text'
        db.add_column(u'map_tweetchunk', 'tweet_text',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TweetChunk.twitter_id'
        db.delete_column(u'map_tweetchunk', 'twitter_id')

        # Deleting field 'TweetChunk.tweet_text'
        db.delete_column(u'map_tweetchunk', 'tweet_text')
