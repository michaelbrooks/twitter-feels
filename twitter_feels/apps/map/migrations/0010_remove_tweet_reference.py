...
class Migration(SchemaMigration):
    ...
    # Do this before migrating tweet type
    needed_by = (
        ("twitter_stream", "0006_auto__chg_field_tweet_id"),
    )

    def forwards(self, orm):
        db.delete_foreign_key(u'map_tweetchunk', 'tweet_id')
        # db.delete_index(u'map_tweetchunk', ['tweet_id'])

    def backwards(self, orm):
        # db.create_index(u'map_tweetchunk', ['tweet_id'])
