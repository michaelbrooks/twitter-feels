...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TweetChunk', fields ['tz_country', 'node']
        db.create_index(u'map_tweetchunk', ['tz_country', 'node_id'])


    def backwards(self, orm):
        # Removing index on 'TweetChunk', fields ['tz_country', 'node']
        db.delete_index(u'map_tweetchunk', ['tz_country', 'node_id'])
