...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MapTimeFrame.cleanup_time'
        db.add_column(u'map_maptimeframe', 'cleanup_time',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MapTimeFrame.cleanup_time'
        db.delete_column(u'map_maptimeframe', 'cleanup_time')
